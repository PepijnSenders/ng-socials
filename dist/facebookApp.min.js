...
socialFacebookApp.directive('socialFacebook', ["$rootScope", "Facebook", "$log", "FacebookEmitter", function($rootScope, Facebook, $log, FacebookEmitter) {
  return {
...
socialFacebookApp.service('Facebook', ["$rootScope", "$q", "FacebookScriptLoader", "$log", "$timeout", function($rootScope, $q, FacebookScriptLoader, $log, $timeout) {
  this.getMe = function() {
...
socialFacebookApp.factory('FacebookEmitter', ["$rootScope", function($rootScope) {
...
socialFacebookApp.factory('FacebookScriptLoader', ["APP_ID", "$q", "$window", function(APP_ID, $q, $window) {
