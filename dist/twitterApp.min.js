...
socialTwitterApp.directive('socialTwitter', ["Twitter", "$window", "TwitterEmitter", function(Twitter, $window, TwitterEmitter) {
  return {
...
socialTwitterApp.service('Twitter', ["TwitterScriptLoader", "TwitterEmitter", "$window", function(TwitterScriptLoader, TwitterEmitter, $window) {
...
socialTwitterApp.factory('TwitterEmitter', ["$rootScope", function($rootScope) {
...
socialTwitterApp.factory('TwitterScriptLoader', ["$q", "$window", function($q, $window) {
...
//# sourceMappingURL=twitterApp.min.js.map